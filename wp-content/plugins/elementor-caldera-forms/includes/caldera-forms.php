...
class Widget_Eael_Caldera_Form_Stand_Alone extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'options' => eael_select_caldera_forms_stand_alone(),
			]
		);
		...
		$this->start_controls_section(
			'eael_section_pro',
			[
				'label' => __( 'Go Premium for More Features', 'elementor-caldera-forms' )
			]
		);
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Unlock more possibilities', 'elementor-caldera-forms' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
					'1' => [
						'title' => __( '', 'elementor-caldera-forms' ),
...
Plugin::instance()->widgets_manager->register_widget_type( new Widget_Eael_Caldera_Form_Stand_Alone() );