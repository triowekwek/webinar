...
class Eael_Caldera_Forms_Admin_Settings {
	...
	public function enqueue_eael_admin_scripts() {
		...
		if( isset( $_GET['page'] ) && $_GET['page'] == 'eael-caldera-forms-settings' ) {
			wp_enqueue_style( 'eael-caldera-forms-admin-css', plugins_url( '/', __FILE__ ).'assets/css/admin.css' );
			wp_enqueue_style( 'eael-caldera-forms-sweetalert2-css', plugins_url( '/', __FILE__ ).'assets/vendor/sweetalert2/css/sweetalert2.min.css' );

			wp_enqueue_script( 'eael-caldera-forms-admin-js', plugins_url( '/', __FILE__ ).'assets/js/admin.js', array( 'jquery', 'jquery-ui-tabs' ), '1.0', true );
			wp_enqueue_script( 'eael-caldera-forms-core-js', plugins_url( '/', __FILE__ ).'assets/vendor/sweetalert2/js/core.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_script( 'eael-caldera-forms-sweetalert2-js', plugins_url( '/', __FILE__ ).'assets/vendor/sweetalert2/js/sweetalert2.min.js', array( 'jquery', 'eael-caldera-forms-core-js' ), '1.0', true );
		}
	...
	public function create_eael_admin_menu() {
		...
		add_menu_page(
			...
			'Elementor Caldera Forms',
			'manage_options',
			'eael-caldera-forms-settings',
			array( $this, 'eael_caldera_forms_admin_settings_page' ),
	 ...
	 * @since 1.1.2
	 */
	public function eael_caldera_forms_admin_settings_page() {
			...
			<div class="response-wrap"></div>
		  		<div class="eael-header-bar">
					<div class="eael-header-left">
						<h4 class="title"><?php _e( 'Elementor Caldera Forms', 'elementor-caldera-forms' ); ?></h4>
					</div>
				</div>
				<?php if( !function_exists( 'eael_activate' ) ): ?>
				<div class="eael-header-bar-after">
					<div class="eael-header-left">
						<h4 class="title-2"><?php _e( 'Get all essential elements in a single plugin!', 'elementor-caldera-forms' ); ?></h4>
						<p class="eael-subtitle-text"><?php _e( 'You can enable certain elements that you are only using. So it will not slow down your site since it won\'t load the associated resources', 'elementor-caldera-forms' ); ?></p>
					</div>
					<div class="eael-header-right">
						<button class="button eael-btn" id="eael-caldera-install-now">Install Essential Addons for Elementor</button>
					</div>
				</div>
				<?php else: ?>
				<div class="error notice is-dismissible">
					<p>Looks like you have <strong>Essential Addons for Elementor</strong> installed.</strong> You can <a href="<?php echo admin_url().'plugins.php' ?>">deactivate</a> <strong>Elementor Caldera Forms</strong> and use Essential Addons.</p>
				</div>
				<?php endif; ?>
					            ...
					            <table class="form-table">
					                <tr>
					                    ...
					                    <td>
					                        <div class="eael-checkbox">
					                            <p class="title">
					                                <?php _e( 'Caldera Forms', 'essential-addons-elementor' ); ?>
					                            </p>
					                            <p class="desc">
					                                <?php _e( 'Activate / Deactivate Caldera Forms', 'essential-addons-elementor' ); ?>
					                            </p>
					                            <input type="checkbox" id="caldera-forms" name="caldera-forms" disabled >
					                            <label for="caldera-forms" class="<?php if( (bool) $this->is_pro === false ) : echo 'eael-get-pro'; endif; ?>"></label>
					                        </div>
					                    </td>
					                    <td>
					                        <div class="eael-checkbox">
...
new Eael_Caldera_Forms_Admin_Settings();